                ...
                <div class="col-xl-3 col-lg-6 col-md-6 mb-30">
                    <div class="card card-statistics h-100">
                        <div class="card-body">
                            ...
                            <p class="text-muted pt-3 mb-0 mt-2 border-top">
                                <i class="fas fa-binoculars mr-1" aria-hidden="true"></i><a href="{{route('add-parents')}}" target="_blank"><span class="text-danger">عرض البيانات</span></a>
                            </p>
                        </div>
                    </div>
                </div>
...
{{--                                                    يعني جبلي بس اخر5--}}
                                                    <tr>
                                                        ...
                                                        <td class="text-success">{{$student->created_at->format('d/m/y H:i')}}</td>
                                                        @empty
                                            ...
                                            <table style="text-align: center"
                                                ...
                                                @forelse(\App\Models\Teacher::latest()->take(5)->get() as $teacher)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-success">{{$teacher->created_at->format('d/m/y H:i')}}</td>
                                                        @empty
                                                            <td class="alert-danger" colspan="8">لاتوجد بيانات</td>
                                                    </tr>
                                                    </tbody>
                                            ...
                                            <table style="text-align: center"
                                                ...
                                                @forelse(\App\Models\MyParent::latest()->take(5)->get() as $parent)
                                                    <tr>
                                                        ...
                                                        <td class="text-success">{{$parent->created_at->format('d/m/y H:i')}}</td>
                                                        @empty
                                                            <td class="alert-danger" colspan="8">لاتوجد بيانات</td>
                                                    </tr>
                                                @endforelse
                                            ...
                                            <table style="text-align: center"
                                                ...
                                                @forelse(\App\Models\FeeInvoice::latest()->take(10)->get() as $section)
                                                    <tr>
                                                        ...
                                                        <td class="text-success">{{$section->created_at->format('d/m/y H:i')}}</td>
                                                    </tr>
                                                @empty
                                                    <tr>
