<button class="btn btn-success btn-sm btn-lg pull-right" wire:click="showformadd" type="button">{{ trans('Parent_trans.add_parent') }}
</button><br><br>
    ...
    <table id="datatable" class="table  table-hover table-sm table-bordered p-0" data-page-length="50"
        ...
        @foreach ($my_parents as $my_parent)
            <tr>
                ...
                <td>
{{--                    يعني لما تكبس على تعديل جبلي معك وانت رايح عالميثود لبالlivewire الid--}}
