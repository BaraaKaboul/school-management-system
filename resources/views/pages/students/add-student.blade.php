...
@section('page-header')
    ...
    <div class="page-title">
        <div class="row">
            <div class="col-sm-6">
                <h4 class="mb-0">{{trans('student_trans.title')}}</h4>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb pt-0 pr-0 float-left float-sm-right ">
                    <li class="breadcrumb-item"><a href="#" class="default-color">Home</a></li>
                    <li class="breadcrumb-item active">{{trans('student_trans.title')}}</li>
                </ol>
            </div>
        </div>
    </div>
...
{{--                                    هاي مشان الcatch مشان يطلعلي الاخطاء البرمجية كإشعار--}}
                                    @if ($errors->any())
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="custom-select mr-sm-2" name="nationalitie_id">
                                                        ...
                                                        @foreach($nationals as $nal)
                                                            <option  value="{{ $nal->id }}">{{ $nal->nat_name }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="custom-select mr-sm-2" name="blood_id">
                                                        ...
                                                        @foreach($bloods as $bg)
                                                            <option value="{{ $bg->id }}">{{ $bg->blood_name }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
...
{{--                                                فائدة accept انو لما اعمل اختيار ملف, مارح يطلعلي بهالحالة غير الصور,,, وفائدة multiple انو فيني اختار اكتر من صورة بنفس الوقت باستخدام CTRL--}}
...
@endsection
@section('js')
{{--    وظيفتو يجبلي classroom المتعلقة ب grade المختار--}}
    <script>
