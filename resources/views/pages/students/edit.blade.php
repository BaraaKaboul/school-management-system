...
@endsection
@section('title')
{{trans('student_trans.edit_title')}}
@stop
...
@section('page-header')
    ...
    <div class="page-title">
        <div class="row">
            <div class="col-sm-6">
                <h4 class="mb-0">{{trans('student_trans.title')}} - {{$Students->name}}</h4>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb pt-0 pr-0 float-left float-sm-right ">
                    <li class="breadcrumb-item"><a href="#" class="default-color">Home</a></li>
                    <li class="breadcrumb-item active">{{trans('student_trans.edit_title')}}</li>
                </ol>
            </div>
        </div>
    </div>
                            ...
                            <div class="card card-statistics h-100">
                                <div class="card-body">
                                    ...
                                    <form action="{{route('students.update','test')}}" method="post" autocomplete="off">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="custom-select mr-sm-2" name="nationalitie_id">
                                                        ...
                                                        @foreach($nationals as $nal)
                                                            <option value="{{ $nal->id }}" {{$nal->id == $Students->nationalitie_id ? 'selected' : ""}}>{{ $nal->nat_name }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="custom-select mr-sm-2" name="blood_id">
                                                        ...
                                                        @foreach($bloods as $bg)
                                                            <option value="{{ $bg->id }}" {{$bg->id == $Students->blood_id ? 'selected' : ""}}>{{ $bg->blood_name }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                        ...
                                        <button class="btn btn-success btn-sm nextBtn btn-lg pull-right" type="submit">{{trans('student_trans.update')}}</button>
                                    </form>
