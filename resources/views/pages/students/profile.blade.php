...
@section('page-header')
    ...
    <div class="page-title">
        <div class="row">
            <div class="col-sm-6">
                <h4 class="mb-0">الملف الشخصي الخاص بالطالب</h4>
            </div>
            <div class="col-sm-6">
        ...
        <section style="background-color: #eee;">
            <div class="row">
                ...
                <div class="col-lg-8">
                    <div class="card mb-4">
                        <div class="card-body">
                            <form action="{{route('profile.user.update',$information->id)}}" method="post">
                                @csrf
                                @method('put')
                                <div class="row">
                                    <div class="col-sm-3">
...
@endsection
@section('js')
    {{--    وظيفة هاد الكود انو يظهرلي الباسوورد لما اكبس على اظهار كلمة المرور--}}
    <script>
        function myFunction() {
