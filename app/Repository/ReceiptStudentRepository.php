...
class ReceiptStudentRepository implements ReceiptStudentRepositoryInterface
{
    ...
    public function store($request)
    {
        ...
        try {
            ...
            // حفظ البيانات في جدول سندات القبض receipt_students
            ...
            // حفظ البيانات في جدول الصندوق fund_accounts
            ...
            // حفظ البيانات في جدول حساب الطالب student_accounts
            ...
            return redirect()->route('receipt-student.index');
